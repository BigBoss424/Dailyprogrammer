/*
Description: The world championship in Tic Tac Toe, The X-Games is underway. We have been asked to write a 
program to see if there is a winning move possible. 
...
Output: 
Shows the board with the winning move in place.
